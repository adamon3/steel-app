...
I'm Adam — equity sales analyst at UBS London, two years into a graduate scheme. I'm building **Steel**, a social fitness app, on the side. Skeleton athlete training toward 2030 Olympics, so the app is genuinely useful to me — I'm a hard user as well as the founder.
...
- **Compliance constraint on me personally**: I work in equity sales at UBS, so I cannot trade individual stocks; my own trading is restricted to broad-based UCITS ETFs. This is irrelevant to the codebase but explains why I won't have insider product opinions about specific finance integrations.
